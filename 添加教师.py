...
# 获取登录接口
login_url = 'http://192.168.1.123/admin.php?m=mgr/admin.chklogin&ajax=1'
# 登录数据
lgn_data = {
    'username': 'admin',
    'password': 'admin',
...
# 获取添加教师接口
add_teacher_url = 'http://192.168.1.123/admin.php?m=mgr/member2.saveMemberInfo&id='
